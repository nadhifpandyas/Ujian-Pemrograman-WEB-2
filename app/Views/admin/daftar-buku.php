                    ...
                    <tbody>
                       <?php foreach($books as $book): ?>
                            <tr>
                                ...
                                <td><button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal" data-bs-id="<?= $book['id'] ?>">
                  <i class="bi bi-trash"></i> Hapus
                </button></td>
                
                                <td><button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal"
                  data-bs-id="<?= $book['id'] ?>"
                  data-bs-NamaBunga="<?= $book['judul'] ?>"
                  data-bs-JenisBunga="<?= $book['pengarang'] ?>"
                  data-bs-JumlahStok="<?= $book['penerbit'] ?>"
                  data-bs-harga="<?= $book['tahun'] ?>">
